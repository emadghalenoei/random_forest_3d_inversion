...
def plot_datagrid(dg_obs, dg_fieldpred, dT_obs, dT_fieldpred, xs, ys, Ndatapoints, iy_data, xticks, yticks, output_path):
    ...
    im02 = axs[0,2].imshow(res_g.reshape((Ndatapoints,Ndatapoints)),interpolation='none', vmin=dgmin,vmax=dgmax ,
                           extent=(xs1,xs2,ys1,ys2), aspect=abs((xs2-xs1)/(ys2-ys1)), cmap='jet')
...
def plot_datainbox(npyfile, XnYnZn, Kernel_Grv, Kernel_Mag, Ndatapoints, xs, output_path):
